...
export default function BulkAccountGenerationPage({ accountType }) {
  ...
  return <BulkAccountUploadPage accountType={accountType} onUploadSuccess={setUploadedFile}>
    ...
    {(manualRows.length > 0 || createdRows.length > 0) && <GeneratedAccountTable entityType={accountType} rows={[...createdRows, ...manualRows]} title="Akun Baru Berhasil Dibuat" subtitle="Simpan password awal sekarang. Password tidak dapat ditampilkan kembali setelah halaman ditutup." />}
