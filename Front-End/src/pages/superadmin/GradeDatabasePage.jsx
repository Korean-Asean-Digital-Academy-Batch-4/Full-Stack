import { AlertCircle, LoaderCircle, RefreshCw, Save } from "lucide-react";
import { useEffect, useMemo, useState } from "react";
import Button from "../../components/ui/Button";
import Toast from "../../components/ui/Toast";
import { getAdminGrades, getClassDetail, getClasses, updateAdminGrades } from "../../services/adminService";
...
export default function GradeDatabasePage() {
  ...
  const students = useMemo(() => { const map = new Map(); (data?.items || []).forEach((row) => map.set(row.student_id, { id: row.student_id, name: row.student_name })); return [...map.values()]; }, [data]);
